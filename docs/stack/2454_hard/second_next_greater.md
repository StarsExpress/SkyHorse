...
[LeetCode Wiki 方法一](https://github.com/doocs/leetcode/blob/main/solution/2400-2499/2454.Next%20Greater%20Element%20IV/README.md) 主轴是Ordered Set 开头需要总排序
...
更新：刚才若各位在LeetCode Wiki的链接中 不小心手滑太快 看见了方法二的双栈解方 那就别怀疑

![2454_Pull_Request](2454_pull_request.png)

__因为这双栈解方是我后来发起的Pull Request 被LeetCode Wiki合并入主干道的__

可是我还是建议各位留在我Blog看解说 __这边的文字更生动有趣😉__
...
**这是我开C++写双栈方法的效能表现 31ms显示AC**

(小声说: Algo Monster和LeetCode Wiki的方法一 在C++耗费了350+ ms __把时间分布表往另一边拉大了__ 详见横轴)
