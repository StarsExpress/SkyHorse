...
总开销 = k个机器人中最大的充电时间 + k * 全部k个机器人们运行成本总和

因此题目问的是 在总开销不超过预算的前提下 最多能 __连续__ 抓多少台机器人同时运行

注意有 __连续__ 这个形容词 __它不接受同时抓第i台和第i + 2台 但不抓第i + 1台的跳跳虎模式__

看到这儿 我们就会察觉一个巧妙的事实：若$0 \le i \e j \e l < n$

一旦连抓第i到第j台机器人时 发现这j + 1 - i台机器人的总开销超过预算

那我们抓第i到第l台机器人时 __一样会看见这l + 1 - i台机器人总开销超过预算 甚至更严重__

为什么呢？ 第i到第j台机器人中最大的充电时间小于等于第i到第l台机器人中最大的充电时间 __前者是后者的子集__

于是公式中的『k个机器人中最大的充电时间』没法下降

又我刚才说过运行成本都是自然数 __因此第i到第l台机器人运行成本总和 > 第i到第j台机器人运行成本总和__

k随著机器人越抓越多只会上涨 既然三个子项都不可能下降 那总开销就不可能下降了

于是我们有个结论：一旦发生了第i到第j台机器人总开销超预算 __非得放弃第i台机器人__ 才有机会压回预算内
...
只要队列尾的充电时间小于等于第```endIdx```台机器人的充电时间 队列尾自然失去作用 弹走就对啰
